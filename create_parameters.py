...
Then the module append this files as parameters in the paramaters.txt file for further use."""
...
def append_parameters(input_files):
    ...
    execution_line = "python csv_interpreter.py {}".format(
        " ".join(write_list))
    print("You can execute the csv_interpreter.py with this parameters:")
